...
public class InventoryController {
	...
	// Histogram
	static final Histogram requestLatency = Histogram.build().name("http_request_duration_seconds")
			.help("HTTP request duration (seconds).").labelNames("method").register(); // Register must be called to add
																						// it to the output

	// Counter
	static final Counter requestsCounter = Counter.build().name("requests_total").help("Total requests.")
	...
	public List<Inventory> getModelInventoryByWarehouse(@PathVariable String modelId,
